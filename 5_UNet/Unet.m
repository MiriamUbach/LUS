...
imgFolderTrain = 'C:\Users\miri_\Desktop\Miriam_TFM\1_Datasets\2_5_LungPreprocessedDataset\1_TrainingSet\InputImg';
mskFolderTrain = 'C:\Users\miri_\Desktop\Miriam_TFM\1_Datasets\2_5_LungPreprocessedDataset\1_TrainingSet\OutGT_4class';
...
imgFolderVal = 'C:\Users\miri_\Desktop\Miriam_TFM\1_Datasets\2_5_LungPreprocessedDataset\2_ValidationSet\InputImg';
mskFolderVal = 'C:\Users\miri_\Desktop\Miriam_TFM\1_Datasets\2_5_LungPreprocessedDataset\2_ValidationSet\OutGT_4class';
...
% Replace last layer with a Weighted cross entropy classification layer
% Inspect label dataset
count_classes = countEachLabel(pxdsTrain);

% Correct for class inbalance using Weighted cross entropy
totalNumberOfPixels = sum(count_classes.PixelCount);
imageFreq = count_classes.PixelCount ./ count_classes.ImagePixelCount;
...
lgraph = replaceLayer(lgraph,'RegressionLayer_Softmax_Layer_Tran_1',cLayer);

% Step 4: Train the UNet
...
netDir = 'C:\Users\Miriam\Documents\Miriam_TFM_LUS\4_LossFunctionTrials\Trial8';
...
resultsDir = 'C:\Users\Miriam\Documents\Miriam_TFM_LUS\4_LossFunctionTrials\Trial8';
